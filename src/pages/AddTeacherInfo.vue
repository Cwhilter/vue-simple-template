<template>
  <main-layout teacher='true'>
    <div class="container">
		...
		<div class="t-form-rows"><span>教师编号</span><input type="text" name="t-theme" placeholder="不能为空" v-model="teacher.number"></div>
		<div class="t-form-rows"><span>教师名称</span><input type="text" name="t-theme" placeholder="不能为空" v-model="teacher.name"></div>
		<div class="t-form-rows"><span>年龄</span><input type="text" name="t-theme" placeholder="不能为空" v-model="teacher.age"></div>
		<div class="t-form-rows"><span class="upload">性别</span>
	    ...
	    <div class="t-form-rows"><span>教师职称</span><input type="text" name="t-theme" placeholder="不能为空" v-model="teacher.position"></div>
	    <div class="t-form-rows"><span>所带班级</span>
    ...
    <div class="t-form-rows"><span>联系电话</span><input id="end" type="text" name="t-date" v-model="teacher.phone_number"></div>
    <div class="t-form-rows"><span>密码</span><input id="end" type="password" name="t-date" v-model="teacher.password"></div>
	<div class="t-form-btn"><button class="btn btn-primary" id="t-info-update" @click="submit"><i class="glyphicon glyphicon-ok"></i>添加</button>
