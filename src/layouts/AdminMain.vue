    ...
    <nav class="navbar navbar-default" role="navigation">
      <div class="container">
        <div class="navbar-header">
          ...
          <router-link class="navbar-brand" to="/admin" title="返回首页">作业提交与批改系统</router-link>
        </div>
        <ul class="nav-list">
          <li>
            <router-link to="/admin/index" :class="{'active':student}">学生信息</router-link>
          </li>
          <li>
            <router-link to="/admin/homeworkInfo" :class="{'active':homework}">作业信息</router-link>
          </li>
          <li>
            <router-link to="/admin/teacherInfo" :class="{'active':teacher}">教师信息</router-link>
          </li>
  
          <li>
            <router-link to="/admin/classInfo" :class="{'active':klass}">班级信息</router-link>
          </li>
        </ul>
        <div class="status">
          <span class="username">{{user.role}}:{{user.name}}
