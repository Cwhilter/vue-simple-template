    ...
    <nav class="navbar navbar-default" role="navigation">
      <div class="container">
        <div class="navbar-header">
          ...
          <v-link class="navbar-brand" href="/teacher" title="返回首页">作业提交与批改系统</v-link>
        </div>
        <ul class="nav-list">
          <li>
            <router-link to="/teacher/index" :class="{'active':index}">作业信息</router-link>
          </li>
          <li>
            <router-link to="/teacher/arrage" :class="{'active':arrage}">布置作业</router-link>
          </li>
          <li>
            <router-link to="/teacher/studentInfo" :class="{'active':student}">学生信息</router-link>
          </li>
          <li>
            <router-link to="/teacher/statistics" :class="{'active':statistics}">成绩统计</router-link>
          </li>
        </ul>
        <div class="status">
